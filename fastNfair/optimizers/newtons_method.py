...
class NewtonsMethod:
    ...
    def solve(self, net, loss, x, y, verbose=False, log_interval=1):
        ...
        # initial evaluation
        f, df_dx, d2f_dx2 = net(x, do_gradient=True, do_Hessian=True)
        ...
        while i < self.max_iter:
            ...
            # update x
            x, infoLS = self.linesearch.step(net, x, s.view(x.shape), f, df_dx.view(x.shape))
