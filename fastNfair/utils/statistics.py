...
if __name__ == "__main__":
    ...
    # s =  [0, 0, 0, 1, 1, 1, 0, 0, 1, 1]
    # Test case 1: Sufficiency
    if out_suf['r = 0']['s = 0'] != 1:
        print('False')
    elif (out_suf['r = 0']['s = 1']) != (2.0/3.0):
        print('False')
    elif (out_suf['r = 1']['s = 0']) != (1.0/2.0):
        print('False')
    elif (out_suf['r = 1']['s = 1']) != 0:
        print('False')
    else:
        print('True')

    print('sufficiency', out_suf)
